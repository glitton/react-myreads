# MyReads App - A book search application
...
Clone or download this repository.  cd into the project root and run npm install.  run npm start.  go to localhost:3000
